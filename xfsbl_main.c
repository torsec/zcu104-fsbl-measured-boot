 ...
 */
// #define XSK_ZYNQMP_BBRAMPS_AES_KEY "45195DE9B5B80119D8DD4E7DF032736D53CF75AD1DC1E61C5BA681CF4A0724E8"
...
// #include "xil_io.h"
// #define GLOBAL_TIMER_BASE 0xF8F00200 // Indirizzo base del timer globale
// uint64_t start_time;
// uint64_t read_global_timer() {
//     uint32_t upper = Xil_In32(GLOBAL_TIMER_BASE);
//     uint32_t lower = Xil_In32(GLOBAL_TIMER_BASE + 4);
...
int main(void )
{
    // uint64_t start_time = read_global_timer();
    // XFsbl_Printf(DEBUG_INFO, "Starting measure time\n");
	/**
	 * Local variables
	 */
...
#error "FSBL should be generated using only EL3 BSP"
		...
		case XFSBL_STAGE1:
			{
				...
				// //load bbram key
				// XFsbl_Printf(DEBUG_INFO, "\nLoading AES Key in BBRAM...\n");
				// u32 Status2 = XST_SUCCESS;
				...
				// /* Validate the key */
				// Status2 = XilSKey_Efuse_ValidateKey(
				...
				// Status2 = XilSKey_ZynqMp_Bbram_Program((u32 *)AesKey);
    ...
    //FINE TIMER
    // uint64_t end_time = read_global_timer();
    // uint64_t elapsed_time = end_time - start_time;
    // XFsbl_Printf(DEBUG_INFO, "Tempo di esecuzione: %llu tick del timer\n", elapsed_time);
	return 0;
}
