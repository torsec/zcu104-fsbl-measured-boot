 ...
 */
 ...
 /* For MEASURED BOOT, add definition for SUPPORT_TPM_SLB9670
 * so that measured boot code is included. Also change FSBL_PRINT_VAL
 * to 0 and FSBL_DEBUG_DETAILED_VAL to 1 so that complete detailed debug
 * information is printed to the console. This will display all the TPM
 * Events and updated PCR values.
 */
